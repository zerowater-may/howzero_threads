...
1. **브랜드/스타일 결정** — 어떤 브랜드/스타일인지 파악하고 해당 프리셋 파일을 읽는다:
   ...
   | `jipsaja`, `집사자`, `go.nyangee`, `부린이`, `내집마련` | 집사자 | `brands/jipsaja/README.md` + `brands/jipsaja/assets/` | 순백 + 노란 pill 형광펜 + Jua 둥근 손글씨 + 손그림 마스코트, 친근 반말 부동산 큐레이션 톤 |
   | 그 외 | — | 사용자에게 톤/브랜드 질문 | — |
...
- **집사자**: `brands/jipsaja/README.md` + `brands/jipsaja/assets/mascot-*.png` (순백 + 노란 pill 형광펜 + Jua 손글씨 + 마스코트 10포즈)
