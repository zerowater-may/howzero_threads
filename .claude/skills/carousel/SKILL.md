...
1. **브랜드/스타일 결정** — 어떤 브랜드/스타일인지 파악하고 해당 프리셋 파일을 읽는다:
   ...
   | 키워드 | 프리셋 | 파일 | 특징 |
   |--------|--------|------|------|
   | `howzero`, `하우제로` | 하우제로 | `brands/howzero.md` + `docs/persona-howzero.md` | 크림 배경 + 파스텔 형광펜 + Nanum Pen Script, 얼리머조리티 창업가 톤 |
   | `braveyong`, `용감한용팀장`, `용팀장` | 용감한용팀장 | `brands/braveyong.md` | 크림/다크 + 붉은·골드 + Black Han Sans, 팩트 폭격·도발 톤 |
   | `mkt`, `mkt.co.kr`, `마케터스클럽`, `브루탈 미니멀`, `미니멀 마케터` | mkt | `brands/mkt.md` | 밝은 회색 + 주황 불릿 1점 + Pretendard Black, 조용한 존댓말 인사이트 톤 |
   | 그 외 | — | 사용자에게 톤/브랜드 질문 | — |
