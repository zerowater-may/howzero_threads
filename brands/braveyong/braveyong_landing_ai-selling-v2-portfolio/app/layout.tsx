...
export const metadata: Metadata = {
  ...
  description:
    "1만 개를 무작정 올리는 셀러에서 효자상품 10개를 만드는 셀러로. 서울 강남 오프라인 4회 + 줌 보강 3회. 2기 모집 중 · 신청서 보고 한 분씩 따로 안내.",
  keywords: [
    "용감한 용팀장",
    "AI 셀링",
    "스마트스토어",
  ...
  openGraph: {
    ...
    title: "4주 오프라인 AI 셀링 실전반 — 용감한 용팀장",
    description:
      "1만 개를 무작정 올리는 셀러에서, 효자상품 10개를 만드는 셀러로. 서울 강남 오프라인 4회 + 줌 보강 3회. 신청서 보고 한 분씩 따로 안내드려요.",
    siteName: "용감한 용팀장",
    images: [
      {
  ...
  twitter: {
    ...
    title: "4주 오프라인 AI 셀링 실전반 — 용감한 용팀장",
    description: "효자상품 10개를 4주 동안 같이 만듭니다. 서울 강남 · 소수정예 · 신청서 보고 한 분씩.",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "1만 개를 무작정 올리는 셀러에서 효자상품 10개를 만드는 셀러로. 오프라인 4회 + 줌 보강 3회, 서울 강남, 소수정예.",
              provider: {
                "@type": "Person",
                name: "용감한 용팀장",
              },
