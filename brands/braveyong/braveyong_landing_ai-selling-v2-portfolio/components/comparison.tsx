...
/**
 * 13 비교표 — 흔한 온라인 강의 vs 6주 오프라인 실전반.
 * 인터뷰 톤: '녹화 한 묶음이 아니라 같이 만드는 과정'을 줄 단위로 풀어둔다.
 */
const rows = [
  ["진행", "녹화 영상 시청, 혼자 멈춤", "현장 작업 + 같이 풀어줌"],
  ["결과물", "지식 · 노트", "효자상품 10개 (내 손으로 직접)"],
  ["피드백", "댓글 / 일괄 답변", "내 상품·내 스토어 1:1"],
  ["중간 점검", "없음 — 못 따라가도 모름", "줌 보강 5회 + 매주 과제"],
  ["SEO 검증", "공식 한 줄", "키워드별 순위 모니터링 같이"],
  ["졸업 후", "종료 — 알아서", "매월 오프라인 스터디 (선택)"],
  ["인원", "무제한 · 누구든", "10~15명 · 신청서 선별"],
]
...
export function Comparison() {
  return (
    <Section
      ...
      lead="같은 6주여도, 끝나고 내 손에 무엇이 남는지가 다릅니다."
    >
