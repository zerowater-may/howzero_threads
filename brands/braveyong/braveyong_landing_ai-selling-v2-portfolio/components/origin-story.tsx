...
const timeline = [
  ...
  {
    year: "오프라인 실전반",
    head: "혼자 막혔던 5주를, 같이 풀어드리려고 만들었습니다.",
    body:
      "강의 한 번 듣고 끝나는 시장이 아닙니다. 그래서 5주 동안 효자상품 10개를 같이 만들고, 졸업 후에도 매월 같이 업데이트합니다.",
  },
]
...
export function OriginStory() {
  return (
    <Section
      ...
      lead="용팀장이 직접 걸어온 길. 매출 자랑이 아니라, 같은 길을 5주로 줄여드리려고 만든 강의입니다."
    >
