 ...
 * 사실: 직장인 → 육아아빠 부업 → 효자상품 → 시스템·스터디.
 * 주의: 용팀장은 지금도 회사에 다닌다(2026-08 확인). 타임라인 라벨 "직장인 시절"은
 * 부업을 시작하기 전 시기를 가리키는 것이지 퇴사를 뜻하지 않는다.
 * 히어로·why-yong·final-cta 서명의 "직장인"은 전부 현재형으로 통일돼 있다.
 */
const timeline = [
  {
    year: "직장인 시절",
