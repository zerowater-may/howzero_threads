...
과제를 매주 해주실 분들과 가고 싶거든요.`}
      ...
      <div className="mb-6 border-2 border-foreground bg-background p-5 sm:p-6">
        ...
        <ol className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {[
            { n: "01", h: "신청서 작성", b: "11문항 약 3분. 지금 상황을 솔직하게 적어주세요." },
            { n: "02", h: "용팀장이 직접 확인", b: "한 분씩 따로 읽고, 카톡으로 먼저 연락드려요." },
            { n: "03", h: "결제 안내", b: "맞다 싶으면 결제 링크 따로 보내드립니다. 카드·이체·무이자 할부 가능." },
            { n: "04", h: "6주 시작", b: "오프라인 1주차 일정·장소를 따로 보내드립니다." },
          ].map((s) => (
