...
const objections = [
  ...
  {
    q: "시간이 없는데 6주 가능할까요?",
    a: "저도 회사·육아 병행하면서 만든 강의입니다. 그래서 매주 1~2개씩, 6주에 총 10개로 쪼갰어요. 새벽이나 점심시간에 한 시간씩만 붙잡고도 따라올 수 있게 설계했습니다.",
  },
  {
    q: "AI를 잘 몰라요.",
    a: "툴 사용법이 목적이 아니에요. AI가 대신 벌어주지도 않습니다. 제가 매번 하던 ‘판단’을 더 빠르게 반복하게 해주는 게 AI고, 그 ‘반복하는 구조’를 6주 동안 같이 만듭니다.",
  },
  {
    q: "오프라인 못 가는 주가 있으면요?",
    a: "그래서 줌 보강 5회와 매주 과제로 받쳐 드립니다. 다만 6주 중 대부분은 직접 오셔야 의미가 있어서, 신청서에서 미리 여쭤봅니다.",
  },
  {
