...
const FAQ: [string, string][] = [
  [
    "부호가 정확히 뭔가요?",
    "세관이 전자상거래 사업자에게 주는 등록번호(통관고유부호)입니다. 8.15부터 수입신고에 필수로 적어야 합니다.",
  ],
  [
  ...
  [
    "은행에서 거절당하면요?",
    "은행·지점마다 정책이 달라 생길 수 있는 일입니다. 다른 은행/비대면을 시도하고, 그래도 막히면 금융인증서·세관 직접 제출로 우회합니다. 특강에서 다 다룹니다.",
  ],
  [
    "기존에 등록했는데 또 해야 하나요?",
  ...
  [
    ...
    "개인계좌 연결을 허용하는 은행이라면 추가 통장 없이 진행 가능합니다. (은행별 확인 필수)",
  ],
  [
    "당일 라이브에 못 들어가면요?",
