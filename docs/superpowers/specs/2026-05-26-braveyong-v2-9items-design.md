...
### #7 — Study 섹션 강화 (강의 끝나도 끝난 게 아니라 될 때까지 같이)
- [ ] `components/study.tsx` 메시지 강화:
  - 현재: "5주 본강의를 끝낸 분만 참여하실 수 있어요."
  - 새: "5주가 끝났다고 끝난 게 아니에요. **될 때까지 같이 갑니다.**"
- [ ] 새 한 줄 추가: "효자상품 10개가 다 굴러갈 때까지, 매월 같이 점검해요." 정도
- [ ] strip top "졸업 후도 함께" 같은 pill 추가 검토
